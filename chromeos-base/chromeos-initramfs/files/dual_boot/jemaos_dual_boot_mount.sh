...
JEMAOS_KERNEL_A="jemaos_vmlinuzA"
JEMAOS_KERNEL_B="jemaos_vmlinuzB"
JEMAOS_IMG="${JEMAOS_ROOT}/jemaos_dual_boot.img"
ROOT_MNT="${JEMAOS_ROOT}/root"
DUAL_BOOT_LABEL="JEMAOS-DUAL-BOOT"
...
get_release_version_from_kernel() {
	local origin_root=$1
	local kernel=$(readlink ${origin_root}/boot/jemaos_vmlinuzA)
	echo ${kernel#*-}
}
